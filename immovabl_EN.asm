...
ACT_EXPLORE		dta d"Explore",b($9b)
ACT_MOVE		dta d"Move",b($9b)
ACT_OPEN		dta d"Open",b($9b)
ACT_USE			dta d"Use",b($9b)
ACT_BITE		dta d"Bite",b($9b)
ACT_SQUEEZE		dta d"Go through",b($9b)
ACT_ACTIVATE	dta d"Activate",b($9b)
ACT_FLUSH		dta d"Flush",b($9b)
ACT_SNIFF		dta d"Sniff",b($9b)
ACT_DROP		dta d"Toss",b($9b)
ACT_HAVECRAP	dta d"Crap into",b($9b)
ACT_TALK		dta d"Talk",b($9b)
ACT_GIVE		dta d"Give",b($9b)
ACT_PLUG		dta d"Seal",b($9b)
ACT_OPERATE		dta d"Do surgery",b($9b)
ACT_CHOP		dta d"Cut a leg",b($9b)
ACT_CLEANUP		dta d"Scrap shit",b($9b)
ACT_INSERT		dta d"Insert",b($9b)
ACT_ENTER		dta d"Enter",b($9b)
ACT_ROTATE		dta d"Rotate",b($9b)
ACT_LICK		dta d"Lick",b($9b)
ACT_UNJAM		dta d"Unjam",b($9b)
ACT_READ		dta d"Read",b($9b)
ACT_PENETRATE	dta d"Penetrate",b($9b)
ACT_TYPE		dta d"Type",b($9b)
ACT_KNOCK		dta d"Knock",b($9b)
ACT_PROFANE		dta d"Profane",b($9b)
ACT_PLACE		dta d"Place",b($9b)
ACT_TICKLE		dta d"Tickle",b($9b)
ACT_SCRATCH		dta d"Scratch",b($9b)
ACT_LUBRICATE	dta d"Lubricate",b($9b)
ACT_EXPLODE		dta d"Explode",b($9b)
ACT_RAPE		dta d"Rape",b($9b)
ACT_PRAY		dta d"Pray",b($9b)
ACT_CARVE		dta d"Carve",b($9b)	
ACT_SPILL		dta d"Spill",b($9b)	
ACT_BLOW		dta d"Blow",b($9b)	
ACT_PUFF		dta d"Puff",b($9b)
ACT_SMASH		dta d"Smash smth",b($9b)
ACT_PUSH		dta d"Push",b($9b)
ACT_FEED		dta d"Feed",b($9b)
ACT_HARASS		dta	d"Harass",b($9b)
ACT_START		dta	d"Start",b($9b)
ACT_GATHER_DNA	dta d"Gather DNA",b($9b)
ACT_POWERUP		dta d"Power up",b($9b)
ACT_SAW			dta d"Saw",b($9b)
ACT_TOSS		dta d"Toss",b($9b)
ACT_CRUSH		dta d"Crush",b($9b)
ACT_CUT			dta d"Cut",b($9b)
ACT_PEE			dta d"Pee",b($9b)
ACT_PEE1		dta d"Pee into",b($9b)
ACT_GATHER		dta d"Gather",b($9b)
ACT_RECITE		dta d"Recite",b($9b)

; Strings representing action objects
A_M0003_001		dta d"Bunk",b($9b)					\ A_M0003_001_ID	equ 1
A_M0003_002		dta d"Wooden door",b($9b)			\ A_M0003_002_ID	equ 2
A_M0003_003		dta d"Grate",b($9b)			\ A_M0003_003_ID	equ 3
A_M0003_004		dta d"Lever",b($9b)					\ A_M0003_004_ID	equ 4
A_M0003_005		dta d"Flush",b($9b)			\ A_M0003_005_ID	equ 5
A_M0003_006		dta d"Toilet",b($9b)						\ A_M0003_006_ID	equ 6
A_M0003_007		dta d"Fragile skull",b($9b)			\ A_M0003_007_ID	equ 7
A_M0003_008		dta d"Heater",b($9b)				\ A_M0003_008_ID	equ 8
A_M0003_009		dta d"Fly swarm",b($9b)			\ A_M0003_009_ID	equ 9
A_M0003_010		dta d"Gap",b($9b)					\ A_M0003_010_ID	equ 10
A_M0003_011		dta d"Barrier",b($9b)					\ A_M0003_011_ID	equ 11
A_M0003_012		dta d"Ghoul",b($9b)		\ A_M0003_012_ID	equ 12
A_M0003_013		dta d"Grate",b($9b)						\ A_M0003_013_ID	equ 13
A_M0003_014		dta d"Vestry door",b($9b)		\ A_M0003_014_ID	equ 14
A_M0003_015		dta d"Broken pipe",b($9b)	\ A_M0003_015_ID	equ 15
A_M0003_016		dta d"Modern door",b($9b)			\ A_M0003_016_ID	equ 16
A_M0003_017		dta d"Mr Zwami",b($9b)					\ A_M0003_017_ID	equ 17
A_M0003_018		dta d"Mutated chicken",b($9b)			\ A_M0003_018_ID	equ 18
A_M0003_019		dta d"Flattened chicken",b($9b)	\ A_M0003_019_ID	equ 19
A_M0003_020		dta d"Cadaver",b($9b)					\ A_M0003_020_ID	equ 20
A_M0003_021		dta d"Gravestone",b($9b)					\ A_M0003_021_ID	equ 21
A_M0003_022		dta d"Fallen rocks",b($9b)				\ A_M0003_022_ID	equ 22
A_M0003_023		dta d"Poop smeared grave",b($9b) \ A_M0003_023_ID	equ 23
A_M0003_024		dta d"Worm ass",b($9b) 				\ A_M0003_024_ID	equ 24
A_M0003_025		dta d"Rat the cheeseeater",b($9b) 			\ A_M0003_025_ID	equ 25
A_M0003_026		dta d"Obelisk",b($9b) 					\ A_M0003_026_ID	equ 26
A_M0003_027		dta d"Column",b($9b) 					\ A_M0003_027_ID	equ 27
A_M0003_028		dta d"Stout weed",b($9b) 		\ A_M0003_028_ID	equ 28
A_M0003_029		dta d"Propulsion candle",b($9b)	\ A_M0003_029_ID	equ 29
A_M0003_030		dta d"Morel",b($9b)					\ A_M0003_030_ID	equ 30
A_M0003_031		dta d"Mongrel",b($9b)					\ A_M0003_031_ID	equ 31
A_M0003_032		dta d"Heavy rock",b($9b) \ A_M0003_032_ID	equ 32
A_M0003_033		dta d"Foot button",b($9b)	\ A_M0003_033_ID	equ 33
A_M0003_034		dta d"Powerful barrier",b($9b)			\ A_M0003_034_ID	equ 34
A_M0003_035		dta d"Hellgate",b($9b)		\ A_M0003_035_ID	equ 35
A_M0003_036		dta d"Hanging skull",b($9b)	\ A_M0003_036_ID	equ 36
A_M0003_037		dta d"Valve",b($9b)				\ A_M0003_037_ID	equ 37
A_M0003_038		dta d"Button",b($9b)						\ A_M0003_038_ID	equ 38
A_M0003_039		dta d"Note",b($9b)					\ A_M0003_039_ID	equ 39
A_M0003_040		dta d"Sinister door",b($9b)	\ A_M0003_040_ID	equ 40
A_M0003_041		dta d"Door to Devil",b($9b)			\ A_M0003_041_ID	equ 41
A_M0003_042		dta d"Tomb gate",b($9b)				\ A_M0003_042_ID	equ 42
A_M0003_043		dta d"Mechanical barrier",b($9b)		\ A_M0003_043_ID	equ 43
A_M0003_044		dta d"Den",b($9b)						\ A_M0003_044_ID	equ 44
A_M0003_045		dta d"Broken door",b($9b) \ A_M0003_045_ID	equ 45
A_M0003_046		dta d"Keyboard",b($9b) 				\ A_M0003_046_ID	equ 46
A_M0003_047		dta d"Label",b($9b) 				\ A_M0003_047_ID	equ 47
A_M0003_048		dta d"Empty altar",b($9b) 		\ A_M0003_048_ID	equ 48
A_M0003_049		dta d"Icicle",b($9b) 					\ A_M0003_049_ID	equ 49
A_M0003_050		dta d"Zombie",b($9b) 					\ A_M0003_050_ID	equ 50
A_M0003_051		dta d"Drunkard",b($9b) 				\ A_M0003_051_ID	equ 51
A_M0003_052		dta d"Beer",b($9b)				\ A_M0003_052_ID	equ 52
A_M0003_053		dta d"Prostitute grave",b($9b) \ A_M0003_053_ID	equ 53
A_M0003_054		dta d"Pile of shit",b($9b) 				\ A_M0003_054_ID	equ 54
A_M0003_055		dta d"Corpse ass",b($9b) 				\ A_M0003_055_ID	equ 55
A_M0003_056		dta d"Corpse feet",b($9b) 				\ A_M0003_056_ID	equ 56
A_M0003_057		dta d"Threaded hole",b($9b) 			\ A_M0003_057_ID	equ 57
A_M0003_058		dta d"Steel door",b($9b) 			\ A_M0003_058_ID	equ 58
A_M0003_059		dta d"Large crate",b($9b) 		\ A_M0003_059_ID	equ 59
A_M0003_060		dta d"Wall",b($9b) 					\ A_M0003_060_ID	equ 60
A_M0003_061		dta d"Richard",b($9b) 					\ A_M0003_061_ID	equ 61
A_M0003_062		dta d"Catholic door",b($9b)			\ A_M0003_062_ID	equ 62
A_M0003_063		dta d"Witch",b($9b)			\ A_M0003_063_ID	equ 63
A_M0003_064		dta d"Freak",b($9b)					\ A_M0003_064_ID	equ 64
A_M0003_065		dta d"Obscene reptile",b($9b)				\ A_M0003_065_ID	equ 65
A_M0003_066		dta d"Dick",b($9b)						\ A_M0003_066_ID	equ 66
A_M0003_067		dta d"Fat paladin",b($9b)				\ A_M0003_067_ID	equ 67
A_M0003_068		dta d"Bronze grave",b($9b) \ A_M0003_068_ID	equ 68
A_M0003_069		dta d"Tin lid",b($9b) 			\ A_M0003_069_ID	equ 69
A_M0003_070		dta d"Pharmacy safe",b($9b) 			\ A_M0003_070_ID	equ 70
A_M0003_071		dta d"Frog",b($9b) 				\ A_M0003_071_ID	equ 71
A_M0003_072		dta d"Salad-bowl",b($9b) 				\ A_M0003_072_ID	equ 72
A_M0003_073		dta d"Flat frog",b($9b)		\ A_M0003_073_ID	equ 73
A_M0003_074		dta d"Unstable coffin",b($9b)			\ A_M0003_074_ID	equ 74
A_M0003_075		dta d"Bad bird",b($9b)		\ A_M0003_075_ID	equ 75
A_M0003_076		dta d"Baba Wanga",b($9b)					\ A_M0003_076_ID	equ 76
A_M0003_077		dta d"Altar",b($9b)			\ A_M0003_077_ID	equ 77
A_M0003_078		dta d"Slug",b($9b)				\ A_M0003_078_ID	equ 78
A_M0003_079		dta d"Control panel",b($9b)			\ A_M0003_079_ID	equ 79
A_M0003_080		dta d"Fustian seat",b($9b)			\ A_M0003_080_ID	equ 80
A_M0003_081		dta d"Doctor's wife",b($9b)		\ A_M0003_081_ID	equ 81
A_M0003_082		dta d"Pump panel",b($9b)				\ A_M0003_082_ID	equ 82
A_M0003_083		dta d"Oak log",b($9b)	\ A_M0003_083_ID	equ 83
A_M0003_084		dta d"Mortar",b($9b)		\ A_M0003_084_ID	equ 84
A_M0003_085		dta d"Drakul",b($9b)						\ A_M0003_085_ID	equ 85
A_M0003_086		dta d"Holy water font",b($9b)				\ A_M0003_086_ID	equ 86
A_M0003_087		dta d"Bad news",b($9b) \ A_M0003_087_ID	equ 87
A_M0003_088		dta d"Fragile ceiling",b($9b) 				\ A_M0003_088_ID	equ 88
A_M0003_089		dta d"Concrete formwork",b($9b) 			\ A_M0003_089_ID	equ 89
